...
if args.dummy_command:
    ...
    command("../utilities/ecs-cli compose --verbose  --cluster {} --project-name {} --file ../docker-compose.yml --file ../docker-compose.aws.yml --file ../docker-compose.aws.deploy.yml --ecs-params ../ecs-params.yml service up".format(cluster, service_name), args)
